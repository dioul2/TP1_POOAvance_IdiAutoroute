...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Voiture voiture1=new Voiture(1,20.0,60,5,autoroute1,2);
        ...
        System.out.println(autoroute1.getCirconferenceAutoroute());
        System.out.println(autoroute2.getCirconferenceAutoroute());
        System.out.println(autoroute3.getCirconferenceAutoroute());
